...
# load data - make sure genes are index
df = pd.read_csv("input/top20_DEGs.csv", index_col=0) 
print(df.shape)
df.head()
...
# load the metadata
metadata = pd.read_csv("input/internal_metadata.csv")
metadata.head()
...
# load external data - make sure genes are index
ex_df = pd.read_csv("input/external_top20_DEGs.csv", index_col=0) 
print(ex_df.shape)
ex_df.head()
...
# load the metadata
ex_metadata = pd.read_csv("input/external_metadata.csv")
ex_metadata.head()
# ensure both columns are strings
